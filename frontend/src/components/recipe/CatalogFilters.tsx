...
export function CatalogFilters({ difficulty, maxPrepMinutes, mealType, query, sort, source, onClear, onDifficultyChange, onMaxPrepMinutesChange, onMealTypeChange, onSortChange, onSourceChange }: CatalogFiltersProps) {
  ...
  return (
    <div className={styles.filterArea}>
      ...
      <button className={styles.mobileFiltersButton} onClick={() => sheetRef.current?.showPopover()} type="button">
